...
<head>
	...
	<script>
		window.onload = function() {
			...
			grid.load({ metadata: [
				...
				{ name: "mercado", datatype: "string", editable: false },
			...
			grid.addCellValidator("mercado", new CellValidator({
	...
	<?php
    	...
    	$data = array(
        	'view' => "dbo.comercio\$locatarios_mercados",
			'accordionTitle' => "Locatarios Mercados",
			'tableData' => $tableData,
			'processJSONarray' => "application/views/php/processJSONarray/padronmercados.php"
