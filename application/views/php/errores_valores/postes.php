...
<div class="col-sm-12">
	...
	<div class="form-group col-sm-6">
		<label><span style="color: red;"><b>*</b></span> Los campos <i id="lblField">EMPRESA</i>, <i id="lblField">MATERIAL</i> y <i id="lblField">CONDICIÓN</i> no deben estar vacíos.</label>
	</div>
	<div class="form-group col-sm-3">
	</div>
</div>
...
<div class="col-sm-12">
	...
	<div class="form-group col-sm-6">
		<label><span style="color: red;"><b>*</b></span> El campo <i id="lblField">EMPRESA</i> requiere una de estas opciones válidas:</label>
